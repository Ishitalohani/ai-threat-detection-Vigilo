# =============================================================================
# AngelaMos | 2026
# Justfile - Vigilo AI Threat Detection
# =============================================================================
...
[group('vigilo')]
vigilo-config:
    cd backend && uv run vigilo config
...
[group('vigilo')]
vigilo-train *ARGS:
    cd backend && uv run vigilo train {{ARGS}}

[group('vigilo')]
vigilo-replay *ARGS:
    cd backend && uv run vigilo replay {{ARGS}}

[group('vigilo')]
vigilo-download-csic:
