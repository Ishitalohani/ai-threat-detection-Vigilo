...
Tests the VigiloExperiment MLflow context manager for run
...
Connects to:
  ml/experiment - VigiloExperiment
"""
...
from ml.experiment import VigiloExperiment
...
class TestVigiloExperiment:
    ...
    def test_failed_status_on_exception(self) -> None:
        ...
        """
        run_id = None
        with pytest.raises(ValueError), VigiloExperiment("test-exp") as exp:
            run_id = exp.run_id
